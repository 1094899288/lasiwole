...
function goJspLogin() {
	location.href = con.app + '/jsp/Login.jsp';
}
function goJspReg() {
	location.href = con.app + '/jsp/Register.jsp';
}
function goLogout() {
	openConfirm(function(index) {
		layer.close(index);
		location.href = con.app + "/admincontroller/logout.do";
	}, '确定注销？');
}
...
function openLayer(url, end) {
	layer.open({
		...
		content : con.app +'/jsp/private'+url
	});
}
