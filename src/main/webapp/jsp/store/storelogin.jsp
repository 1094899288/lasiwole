...
<body>
            ...
            <div class="layui-form-item login-btn">
              <div class="layui-input-block">
                <button class="layui-btn" lay-submit lay-filter="demo1" onclick="return false">登录</button>
                            ...
                            <div class="layui-input-block">
               <a href="javascript:register()" class="layui-btn" style="
	  ...
	  $.ajax({
			 ...
			 success:function(data){//data是SerVlet的response。getwriter().print(data)中的data的值
				 ...
				 if(data=="1"){
					 console.log(data);
					 layer.msg("登录成功");
					 location.href="/secondproject/jsp/store/storeprivate/index.jsp"
  ...
  function register(){
	  console.log("544645646456")
	  location.href="/secondproject/jsp/store/storeregister.jsp"
  }
  </script>
