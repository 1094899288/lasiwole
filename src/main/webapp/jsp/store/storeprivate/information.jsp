...
<body>
      ...
      <div class="inner-cont0">
        <div class="inner-cont1 w1200">
          <div class="inner-cont2">
            ...
            <a href="/secondproject/jsp/store/storeprivate/information.jsp"  class="active">母婴资讯</a>
    ...
    <div class="info-list-box">
      <div class="info-list w1200">
        <div class="item-box layui-clear" id="list-cont">
          <div class="item">
            <div class="img">
              <img src="/secondproject/common/static/img/new1.jpg" alt="">
            </div>
            <div class="text">
          ...
          <div class="item">
            <div class="img">
              <img src="/secondproject/common/static/img/new2.jpg" alt="">
            </div>
            <div class="text">
              <h4>周岁内的宝宝消化不良拉肚子怎么办?</h4>
              <p class="data">2016-12-24 16:33:26</p>
  ...
  <!-- <script type="text/html" id="demo">
    ...
    <div class="item">
      <div class="img">
        <img src="/secondproject/common/img/new1.jpg" alt="">
      </div>
      <div class="text">
        <h4>周岁内的宝宝消化不良拉肚子怎么办?</h4>
        <p class="data">2016-12-24 16:33:26</p>
