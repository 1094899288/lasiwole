								...
								<div class="pay-confirm clearfix">
								   ...
								   <span class="province">湖北</span>省
									...
									<div id="holyshit269" class="submitOrder">
										...
										<a id="J_Go1" href="javascript:chakan()" class="btn-go" tabindex="0" title="点击此按钮，提交订单">查看历史订单</a>&nbsp;&nbsp;&nbsp;
											<a id="J_Go" class="btn-go" tabindex="0" title="点击此按钮，提交订单">已支付</a>
										</div>
									</div>
									<div class="clear"></div>
								</div>
...
<%-- 			var num = '<%=request.getParameter("number")%>' --%>
			...
			function chakan(){
				...
				location.href="/secondproject/jsp/private/order1.jsp?username="+username
			}
			</script>
	</body>
</html>